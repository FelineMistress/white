...
/datum/uplink_item/role_restricted/scarecrow
	name = "Набор пугала"
	desc = "Включает в себя 6 газовых гранат с психотропными веществами и маску, с мощной системой фильтрации воздуха. Противогаз имеет функцию обратной акселирации фильтров, при использовании выдыхая дым и ненадолго активирую термосенсорный визор."
